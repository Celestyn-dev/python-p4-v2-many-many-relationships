...
# Association table: employees and meetings
...
class Employee(db.Model):
    ...
    projects = association_proxy('assignments', 'project', creator=lambda p: Assignment(project=p))
...
class Project(db.Model):
    ...
    employees = association_proxy('assignments', 'employee', creator=lambda e: Assignment(employee=e))
